...
function ChatCard({ convoId, name, timestamp, isActive, onSelect, unreadCount, leftSection, subtitle }: ChatCardProps) {
  return (
    <Card
      key={convoId}
      className={cn(
        'border-none p-3 cursor-pointer transition-smooth glass hover:muted/30',
