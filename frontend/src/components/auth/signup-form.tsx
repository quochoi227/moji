            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col items-center text-center gap-2">
                ...
                <p className="text-muted-foreground text-balance">
                  Chào mừng bạn đến với Moji! Hãy đăng ký để bắt đầu.
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-2">
                  <Label htmlFor="lastname" className="block text-small">
                    Họ
                  </Label>
                ...
                <div className="space-y-2">
                  <Label htmlFor="firstname" className="block text-small">
                    Tên
                  </Label>
              ...
              <div className="flex flex-col gap-3">
                ...
                <Input type="email" id="email" placeholder="m@gmail.com" {...register('email')}></Input>
